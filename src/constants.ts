...
export const DATA_VERSION = '2.1'; // Version bump
...
export const ALLERGENS_CONFIG: Record<AllergenType, { label: string, iconName: string }> = {
  'Glutine': { label: 'Cereali contenenti glutine', iconName: 'Wheat' },
  'Crostacei': { label: 'Crostacei', iconName: 'Shell' },
  'Uova': { label: 'Uova', iconName: 'Egg' },
  'Pesce': { label: 'Pesce', iconName: 'Fish' },
  'Arachidi': { label: 'Arachidi', iconName: 'Nut' },
  'Soia': { label: 'Soia', iconName: 'Bean' },
  'Latte': { label: 'Latte', iconName: 'Milk' },
...
export const DIY_OPTIONS = {
  ...
  steps: [
    ...
    // ... (Step 2, 3, 4 same as before, abbreviated for clarity but keep them in your file!)
    {
      id: 2,
      title: "La Carne",
    ...
    },
    {
      ...
      options: [
        { name: "OPZIONE N°1: Cipolle rosse cotte (sfumate con aceto balsamico), Grana in scaglie, Pomodorini conditi, Salsa boscaiola", price: 4.00, translations: { en: { name: "OPTION #1: Cooked red onions (with balsamic vinegar), Parmesan flakes, Seasoned cherry tomatoes, Boscaiola sauce" }, fr: { name: "OPTION N°1: Oignons rouges cuits (au vinaigre balsamique), Copeaux de Grana, Tomates cerises assaisonnées, Sauce boscaiola" }, de: { name: "OPTION NR.1: Gekochte rote Zwiebeln (mit Balsamico), Grana-Flocken, Gewürzte Kirschtomaten, Boscaiola-Soße" } } },
        { name: "OPZIONE N°2: Gorgonzola, Bacon, Julienne di lattuga, Pomodorini conditi, Melanzane fritte", price: 5.00, translations: { en: { name: "OPTION #2: Gorgonzola, Bacon, Lettuce julienne, Seasoned cherry tomatoes, Fried eggplant" }, fr: { name: "OPTION N°2: Gorgonzola, Bacon, Julienne de laitue, Tomates cerises assaisonnées, Aubergines frites" }, de: { name: "OPTION NR.2: Gorgonzola, Speck, Salatstreifen, Gewürzte Kirschtomaten, Gebratene Auberginen" } } },
        { name: "OPZIONE N°3: Cheddar, Bacon, Pomodorini secchi, Salsa burger, Cipolle rosse cotte (sfumate con aceto balsamico)", price: 5.00, translations: { en: { name: "OPTION #3: Cheddar, Bacon, Dried tomatoes, Burger sauce, Cooked red onions (with balsamic vinegar)" }, fr: { name: "OPTION N°3: Cheddar, Bacon, Tomates séchées, Sauce burger, Oignons rouges cuits (au vinaigre balsamique)" }, de: { name: "OPTION NR.3: Cheddar, Speck, Getrocknete Tomaten, Burger-Soße, Gekochte rote Zwiebeln (mit Balsamico)" } } },
        ...
        { name: "OPZIONE N°5: Ketchup, Maionese, Pomodorini, Lattuga, Bacon, Cipolle rosse cotte (sfumate con aceto balsamico), Edamer", price: 6.50, translations: { en: { name: "OPTION #5: Ketchup, Mayonnaise, Cherry tomatoes, Lettuce, Bacon, Cooked red onions (with balsamic vinegar), Edam cheese" }, fr: { name: "OPTION N°5: Ketchup, Mayonnaise, Tomates cerises, Laitue, Bacon, Oignons rouges cuits (au vinaigre balsamique), Edam" }, de: { name: "OPTION NR.5: Ketchup, Mayonnaise, Kirschtomaten, Salat, Speck, Gekochte rote Zwiebeln (mit Balsamico), Edamer" } } },
        { name: "OPZIONE N°6: Ketchup, Maionese, Cheddar, Pomodorini, Lattuga, Zucchine fritte, Salsa burger", price: 5.50, translations: { en: { name: "OPTION #6: Ketchup, Mayonnaise, Cheddar, Cherry tomatoes, Lettuce, Fried zucchini, Burger sauce" }, fr: { name: "OPTION N°6: Ketchup, Mayonnaise, Cheddar, Tomates cerises, Laitue, Courgettes frites, Sauce burger" }, de: { name: "OPTION NR.6: Ketchup, Mayonnaise, Cheddar, Kirschtomaten, Salat, Gebratene Zucchini, Burger-Soße" } } }
      ]
    },
    {
      id: 4,
...
export const UI_TRANSLATIONS: Record<string, Record<LanguageCode, string>> = {
  ...
  'add': { it: 'Aggiungi', en: 'Add', fr: 'Ajouter', de: 'Hinzufügen' },
  ...
  'addons_banner': { it: 'Aggiunta ingredienti da € 1,00 a € 6,00', en: 'Extra ingredients from € 1.00 to € 6.00', fr: 'Ingrédients supplémentaires de 1,00 € à 6,00 €', de: 'Zusätzliche Zutaten von 1,00 € bis 6,00 €' },
  'frozen_product': { it: '* Prodotto surgelato', en: '* Frozen product', fr: '* Produit surgelé', de: '* Tiefkühlprodukt' },
  'allergens': { it: 'Allergeni', en: 'Allergens', fr: 'Allergènes', de: 'Allergene' },
};
...
// Aggiunte Extra (visibili solo in Admin o Modale)
